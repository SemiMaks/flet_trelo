...
class Board(UserControl):
    ...
    def __init__(self, app, store: DataStore, name: str):
        ...
        self.add_list_button = FloatingActionButton(
            icon=icons.ADD, text="добавить список", height=30, on_click=self.create_list)
    ...
    def create_list(self, e):
        ...
        def textfield_change(e):
            ...
            self.page.update()
        dialog_text = TextField(label="Новое имя списка",
        ...
        dialog = AlertDialog(
            title=Text("Назовите свой новый список"),
            content=Column([
